...
{
    {
      ### 10%
      {
        ...
        # plan(sequential)
        # }
        # saveRDS(imputation_results.10.2, 'imputation_results.10.2.RDS')
        imputation_results.10<-readRDS('./rmse_nomass/imputation_results.10.2.RDS')
      }
      {
      ...
      ### 20%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.20,'imputation_results.20.RDS')
        imputation_results.20<-readRDS('./rmse_nomass/imputation_results.20.RDS')
      }
      {
        # Extract masked positions from mask_set
      ...
      ### 30%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.30, 'imputation_results.30.RDS')
        imputation_results.30<-readRDS('./rmse_nomass/imputation_results.30.RDS')
      }
      {
        # Extract masked positions from mask_set
      ...
      ### 40%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.40, 'imputation_results.40.RDS')
        imputation_results.40<-readRDS('./rmse_nomass/imputation_results.40.RDS')
      }
      {
        # Extract masked positions from mask_set
      ...
      ### 50%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.50, 'imputation_results.50.RDS')
        imputation_results.50<-readRDS('./rmse_nomass/imputation_results.50.RDS')
      }
      {
        # Extract masked positions from mask_set
      ...
      ##60%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.60, 'imputation_results.60.RDS')
        imputation_results.60<-readRDS('./rmse_nomass/imputation_results.60.RDS')
      ...
      ##70%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.70, 'imputation_results.70.RDS')
        imputation_results.70<-readRDS('./rmse_nomass/imputation_results.70.RDS')
      ...
      ##80%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.80, 'imputation_results.80.RDS')
        imputation_results.80<-readRDS('./rmse_nomass/imputation_results.80.RDS')
      ...
      ##90%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.90, 'imputation_results.90.RDS')
        imputation_results.90<-readRDS('./rmse_nomass/imputation_results.90.RDS')
...
{
    {
      ### 10%
      {
        ...
        # plan(sequential)
        # }
        # saveRDS(imputation_results.mass.10, 'imputation_results.mass.10.RDS')
        imputation_results.mass.10<-readRDS('./rmse_mass/imputation_results.mass.10.RDS')
      }
      {
        # Extract masked positions from mask_set
        mask_set.10_masked_positions <- lapply(mask_set.10, function(x) x$masked_positions)
      ...
      ### 20%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.mass.20,'imputation_results.mass.20.RDS')
        imputation_results.mass.20<-readRDS('./rmse_mass/imputation_results.mass.20.RDS')
      }
      {
        # Extract masked positions from mask_set
        mask_set.20_masked_positions <- lapply(mask_set.20, function(x) x$masked_positions)
      ...
      ### 30%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.mass.30, 'imputation_results.mass.30.RDS')
        imputation_results.mass.30<-readRDS('./rmse_mass/imputation_results.mass.30.RDS')
      }
      {
        # Extract masked positions from mask_set
        mask_set.30_masked_positions <- lapply(mask_set.30, function(x) x$masked_positions)
      ...
      ### 40%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.mass.40, 'imputation_results.mass.40.RDS')
        imputation_results.mass.40<-readRDS('./rmse_mass/imputation_results.mass.40.RDS')
      }
      {
        # Extract masked positions from mask_set
        mask_set.40_masked_positions <- lapply(mask_set.40, function(x) x$masked_positions)
      ...
      ### 50%
      {
        ...
        #   plan(sequential)
        # }
        # saveRDS(imputation_results.mass.50, 'imputation_results.mass.50.RDS')
        imputation_results.mass.50<-readRDS('./rmse_mass/imputation_results.mass.50.RDS')
      }
      {
        # Extract masked positions from mask_set
        mask_set.50_masked_positions <- lapply(mask_set.50, function(x) x$masked_positions)
      ...
      ##60%
      {
        ...
        #         plan(sequential)
        #       }
        #       saveRDS(imputation_results.mass.60, 'imputation_results.mass.60.RDS')
        imputation_results.mass.60<-readRDS('./rmse_mass/imputation_results.mass.60.RDS')
      ...
      ##70%
      {
        ...
        #         plan(sequential)
        #       }
        #saveRDS(imputation_results.mass.70, 'imputation_results.mass.70.RDS')
        imputation_results.mass.70<-readRDS('./rmse_mass/imputation_results.mass.70.RDS')
      ...
      ##80%
      {
        ...
        #         plan(sequential)
        #       }
        #saveRDS(imputation_results.mass.80, 'imputation_results.mass.80.RDS')
        imputation_results.mass.80<-readRDS('./rmse_mass/imputation_results.mass.80.RDS')
      ...
      ##90%
      {
        ...
        #         plan(sequential)
        #       }
        #saveRDS(imputation_results.mass.90, 'imputation_results.mass.90.RDS')
        imputation_results.mass.90<-readRDS('./rmse_mass/imputation_results.mass.90.RDS')
